...
# Exporting Interesting features in .csv
sort_score_df.to_csv(pj('/home/STUDENTI/alessandr.dagostino2/Python-Projects/Brain Challenge/Scripts/Sorted_scores.csv'))
